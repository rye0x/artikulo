...
from ..services.post_service import get_posts, create_post, get_post_by_id, update_post, delete_post, get_posts_by_user_id
import logging
...
# Route to get posts for the current authenticated user
