      ...
      <div className="container mx-auto py-6 flex">
        ...
        <main className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-6">
          {posts.map((post) => (
            <Card
              key={post.post_id}
              className="border border-gray-200 shadow-md rounded-lg overflow-hidden cursor-pointer hover:shadow-lg transition h-full flex flex-col"
            ...
            >
              ...
              <CardContent className="p-4 flex-1 flex flex-col">
                {/* Title */}
                <h2 className="text-sm font-semibold mb-1 line-clamp-2">{post.title}</h2>
              ...
              <CardFooter className="p-3 border-t border-gray-200 flex justify-between bg-muted/10 text-xs">
